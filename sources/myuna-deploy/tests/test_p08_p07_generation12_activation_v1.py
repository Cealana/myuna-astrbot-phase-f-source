...
import activate_p08_p07_generation12_v1 as activation
...
class Generation12CombinedActivationTests(unittest.TestCase):
    def test_plan_binds_all_three_phases_and_accepts_continuity_reset(self) -> None:
        ...
        self.assertEqual(prepared.combined_release_set.p07["generation"], 12)
    ...
    def test_adr_freezes_continuity_reset_and_reverse_rollback(self) -> None:
        text = (
            ...
            / "docs/ADR-063-p08-p07-generation12-atomic-release-set-v1.md"
        ).read_text("utf-8")
