...
import activate_p07_core_local_projection_v1 as activation  # noqa: E402


class P07CoreLocalProjectionActivationTests(unittest.TestCase):
    def test_release_evidence_and_receipts_are_content_free(self) -> None:
        ...
        self.assertEqual(artifact["verification"]["core_tests"], 517)
    ...
    def test_activation_has_no_health_provider_or_private_content_probe(self) -> None:
        source = (
            SCRIPTS / "activate_p07_core_local_projection_v1.py"
