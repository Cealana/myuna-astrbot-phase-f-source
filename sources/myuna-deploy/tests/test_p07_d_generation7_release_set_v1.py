...
from myuna_core.external_context.release_set import P07DReleaseSet, RELEASE_SET_EPOCH_PATH_7
...
class Generation7ReleaseSetTests(unittest.TestCase):
    def test_selector_closes_generation_four_to_seven(self) -> None:
        ...
        self.assertEqual(payload["database_path"], RELEASE_SET_EPOCH_PATH_7)
    ...
    def test_manifest_round_trip_binds_epoch_and_rollback(self) -> None:
        ...
        self.assertEqual(selected.generation, 7)
