...
import activate_p07_core_local_sections_v1 as activation  # noqa: E402


class P07CoreLocalSectionsActivationTests(unittest.TestCase):
    def test_release_evidence_and_receipts_are_content_free(self) -> None:
        ...
        self.assertEqual(artifact["verification"]["core_tests"], 521)
        self.assertEqual(
            artifact["verification"]["local_definition_projection"],
            "exact-core-sections-v1",
        )
    ...
    def test_plan_preserves_session_profile_and_both_owner_channels(self) -> None:
        ...
        self.assertEqual(
            ...
            "exact-approved-skill-sections-v1",
        )
    ...
    def test_activation_has_no_health_provider_or_private_content_probe(self) -> None:
        source = (
            SCRIPTS / "activate_p07_core_local_sections_v1.py"
