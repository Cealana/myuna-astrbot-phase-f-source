#!/usr/bin/env python3
"""Select the exact P07 Core release with bounded local Definition projection."""
...
CURRENT_RELEASE = "0e13e9e6964515591cba9d1af157f42cf40dd5529472e181df86136798eb1ea4"
CURRENT_BINDING_SHA256 = (
    "c470b1631eb6f5c2ddee6ed7c2226173f5faa2adaad7f06a774ee87a847c0025"
)
CURRENT_SELECTOR_SHA256 = (
    "6021edf8411dfe3711a50bbf7747b4d1085eabd2166c29605fa8ca894c28b500"
)
TARGET_RELEASE = "8d0497be37db5aa797843d0367cd24f71b1ad20f7006abc61f1eff205c22cc9c"
TARGET_COMMIT = "ce90e921cd7fb6fac44398d1122adc36b0abab75"
...
BACKUP_ROOT = Path("/var/backups/myuna/p07-core-local-definition-projection-v1")
RECEIPT_ROOT = Path(
    "/var/lib/myuna/core-release-selector/p07-local-definition-projection"
)
RECEIPT = RECEIPT_ROOT / "LAST_ACTIVATION.json"
SCHEMA = "myuna.p07-core-local-definition-projection-activation.v1"
...
def artifact_manifest_bytes() -> bytes:
    return canonical_json_bytes(
        {
            "schema": "myuna.core-source-artifact.p07-local-definition-projection-v1",
            ...
            "verification": {
                ...
                "local_definition_projection": "entrypoint-only-v1",
            },
        }
    )
    ...
    return canonical_json_bytes(
        {
            ...
            "target": {
                ...
                "local_input_limit_characters": 24_000,
                "projection": "newest-complete-turns-preserve-system-and-final-user",
                "definition_projection": "approved-skill-entrypoint-only-v1",
...
def validate_candidate(candidate: Path) -> None:
    ...
    probe = (
        ...
        "definition_projection='entrypoint_only'));"
        "assert p.applied and p.request.messages[0]['role']=='system';"
        "assert p.request.definition_projection=='entrypoint_only';"
