#!/usr/bin/env python3
"""Select the exact P07 Core release with bounded local-provider projection."""
...
CURRENT_RELEASE = "d540f76ee83710153937769dfa433d651767e9a9443c3678539314020a3175fc"
CURRENT_BINDING_SHA256 = (
    "71de0d83ed1595595dd5d4c7a0731d4f2d85df6716dcdbf27f33824cb3703b58"
)
CURRENT_SELECTOR_SHA256 = (
    "9303afc3874c5ae2c66a91a9e545e3a6f7946a5f4e074429efe7e1579bda7b7e"
)
TARGET_RELEASE = "0e13e9e6964515591cba9d1af157f42cf40dd5529472e181df86136798eb1ea4"
TARGET_COMMIT = "e878f34f435bad255e417bb939f7efb6b4e4eb10"
...
BACKUP_ROOT = Path("/var/backups/myuna/p07-core-local-projection-v1")
RECEIPT_ROOT = Path("/var/lib/myuna/core-release-selector/p07-local-projection")
RECEIPT = RECEIPT_ROOT / "LAST_ACTIVATION.json"
SCHEMA = "myuna.p07-core-local-projection-activation.v1"
...
def artifact_manifest_bytes() -> bytes:
    return canonical_json_bytes(
        {
            "schema": "myuna.core-source-artifact.p07-local-projection-v1",
...
def validate_candidate(candidate: Path) -> None:
    ...
    probe = (
        ...
        "m=[{'role':'system','content':'s'*10000}];"
        "m.extend(x for i in range(52) for x in "
        "({'role':'user','content':'u'*700},{'role':'assistant','content':'a'*700}));"
